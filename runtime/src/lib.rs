...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("klug-dossier"),
	impl_name: create_runtime_str!("klug-dossier"),
	authoring_version: 1,
	spec_version: 201,
	impl_version: 1,
...
parameter_types! {
	pub const AssetDeposit: u128 = 1 * DOLLARS;
	pub const ApprovalDeposit: u128 = 1 * DOLLARS;
